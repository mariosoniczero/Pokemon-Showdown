export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	victreebel: {
		...
		evoItem: "Leaf Stone",
		eggGroups: ["Grass"],
		otherFormes: ["Victreebel-Mega", "Victreebel-Mega-G"],
	...
	tatsugiri: {
		...
		color: "Red",
		eggGroups: ["Water 2"],
		otherFormes: ["Tatsugiri-Droopy", "Tatsugiri-Stretchy", "Tatsugiri-Curly-Mega", "Tatsugiri-Droopy-Mega", "Tatsugiri-Stretchy-Mega", "Tatsugiri-Mega-G"],
		formeOrder: ["Tatsugiri", "Tatsugiri-Droopy", "Tatsugiri-Stretchy", "Tatsugiri-Curly-Mega", "Tatsugiri-Droopy-Mega", "Tatsugiri-Stretchy-Mega", "Tatsugiri-Mega-G"],
	},
	tatsugiridroopy: {
		num: 978,
